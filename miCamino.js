...
console.log(`El material que vamos a llevar es : `)
...
for (let i = 0; i < miCamino.material.length; i++) {
  ...
  //console.log(`lo primero que debo llevar es ${material1.nombre} y es ${material1.descripcion}`)}
...
console.log(miCamino.material[0].imagenes[0]);
console.log(miCamino.material[0].imagenes[1]);
console.log(miCamino.material[1].imagenes[0]);
console.log(miCamino.material[1].imagenes[1]);
console.log(miCamino.material[2].imagenes[0]);
console.log(miCamino.material[2].imagenes[1]);
console.log(miCamino.material[3].imagenes[0]);
console.log(miCamino.material[3].imagenes[1]);
